...
.cmp-table {
    ...
    background-color: #ffffff !important; /* all rows white */
    color: #1c2b22 !important; /* black text for rows */
}

/* Table header */
.cmp-table th {
    background-color: #2f7d57 !important; /* ESG-Constrained green */
    color: #ffffff !important; /* white text for header */
    font-weight: 600;
    text-align: left;
    padding: 10px 14px;
    border: 1px solid #e2ece6; /* subtle border */
}
...
.cmp-table td {
    ...
    border: 1px solid #e2ece6; /* subtle border */
    background-color: #ffffff !important; /* all rows white */
    color: #1c2b22 !important; /* black text */
}

/* Optional hover effect */
.cmp-table tr:hover td {
    background-color: #e6f2ec !important; /* light green on hover */
}
</style>
